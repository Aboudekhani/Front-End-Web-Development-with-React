...
export const fetchComments= () => (dispatch) => {
    ...
    .catch(error => {
        dispatch(commentesFailed(error.message))
    })
}
...
export const commentesFailed =(errmess)=>({
...
export const postFeedback = (firstname, lastname, telnum, email,agree,contactype,message) => () => {
